...
void RenderScene(Shader &shader, unsigned int & planeVAO, unsigned int & cubeVAO, Maze* & our_maze, bool useTexture, unsigned int cubeTexture = 0);
...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glBindTexture(GL_TEXTURE_2D, depthMap);
		//迷宫 & 地板
		RenderScene(cubeShader, planeVAO, cubeVAO, our_maze, true, cubeTexture);
		//人体模型
		/*modelShader.use();
...
void RenderScene(Shader &shader, unsigned int & planeVAO, unsigned int & cubeVAO, Maze* & our_maze, bool useTexture, unsigned int cubeTexture) {
