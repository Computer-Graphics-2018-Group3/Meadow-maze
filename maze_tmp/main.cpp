...
int main()
{
	...
	// vector<std::string> faces
	// {
	// 	"skybox/haiyang_textures/haiyang_R.jpg",
	// 	"skybox/haiyang_textures/haiyang_L.jpg",
	// 	"skybox/haiyang_textures/haiyang_U.jpg",
	// 	"skybox/haiyang_textures/haiyang_D.jpg",
	// 	"skybox/haiyang_textures/haiyang_B.jpg",
	// 	"skybox/haiyang_textures/haiyang_F.jpg"
	// };
	...
	glm::vec3 movePos(10.0f, -1.0f, -10.0f);			// 控制wave位置
	...
	// Load font as face
	FT_Face face;
	if (FT_New_Face(ft, "/Users/Eddie/Desktop/Maze_v8/maze_text.ttf", 0, &face))
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glEnable(GL_BLEND);
		glBlendFunc(GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA);
		RenderText(textShader, "Harry Potter's Maze", 25.0f, 25.0f, 1.0f, glm::vec3(0.3, 0.7f, 0.9f));
		glDisable(GL_BLEND);
