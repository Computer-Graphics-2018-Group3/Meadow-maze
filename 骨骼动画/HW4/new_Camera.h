...
const GLfloat new_YAW = -90.0f;
const GLfloat new_PITCH = 0.0f;
const GLfloat new_SENSITIVTY = 0.1f;
const GLfloat new_FOV = 45.0f;
...
public:
	...
	New_Camera(glm::vec3 pos = glm::vec3(0.0f, 0.0f, 1.0f), glm::vec3 up = glm::vec3(0.0f, 1.0f, 0.0f)) : 
		camera_front(glm::vec3(0.0f, 0.0f, -1.0f)), yaw(new_YAW), pitch(new_PITCH), fov(new_FOV), sensitivity(new_SENSITIVTY)
	{
		camera_pos = pos;
		world_up = up;
