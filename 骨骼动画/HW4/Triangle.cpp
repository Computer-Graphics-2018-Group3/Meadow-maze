...
void Triangle::init()
{
	...
	matr_model_1 = glm::scale(matr_model_1, glm::vec3(0.2f, 0.2f, 0.2f));
	matr_model_1 = glm::translate(matr_model_1, glm::vec3(0.0f, 0.0f, -4.5f));
...
void Triangle::update(Camera camera)
{
	...
	perspective_projection = glm::perspective(glm::radians(camera.Zoom), (float)SCR_WIDTH / (float)SCR_HEIGHT, 0.1f, 1000.0f);

	// model_man.update();

	// model 1 matrix (MAN)
	// matr_model_1 = glm::translate(matr_model_1, glm::vec3(0.0f, -0.1f, -0.1f));
