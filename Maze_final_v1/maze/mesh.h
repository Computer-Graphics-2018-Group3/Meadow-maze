...
public:
    ...
    /*  Functions  */
    // constructor
    Mesht(vector<Vertext> vertices, vector<unsigned int> indices, vector<Texturet> textures)
    {
...
private:
    ...
    void setupMesh()
    {
        ...
        glVertexAttribPointer(3, 3, GL_FLOAT, GL_FALSE, sizeof(Vertext), (void*)offsetof(Vertext, Tangent));
        // vertex bitangent
        glEnableVertexAttribArray(4);
        glVertexAttribPointer(4, 3, GL_FLOAT, GL_FALSE, sizeof(Vertext), (void*)offsetof(Vertext, Bitangent));
