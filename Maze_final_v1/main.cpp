...
unsigned int walkingManIndices[] = {
	0, 1, 2,
	1, 2, 3,
	1, 0, 5,
	0, 5, 4,
...
int main()
{
	...
	Shader walkingmanShader("shader/walkingman_shader.vs", "shader/walkingman_shader.fs");
	...
	// // walking man VAO
	// unsigned int walkingmanVAO, walkingmanVBO;
	...
	// glEnableVertexAttribArray(1);
	// GLuint textureID = loadTexture("img/uvtemplate.tga");
	// // 坐标在0-1之间
	// static GLfloat uv[] = {
	// 	1.0f, 0.0f,
	// 	0.0f, 1.0f,
